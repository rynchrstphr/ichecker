    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <button class="btn btn-sm btn-primary" onclick="window.location.href='<?php echo base_url(); ?>User/userVerifyScan'">Scan Again</button>
        </div>
      </div>
    </div>
    <br>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 text-center">
          ...
          <br>
          <button class="btn btn-sm btn-primary" onclick="window.location.href='<?php echo base_url(); ?>User/userVerifyScan'">Scan Again</button>
          <a href="<?php echo base_url(); ?>User/loadMainUI" class="btn btn-sm btn-danger" style="margin-left: 5px;">Cancel</a>
        </div>
      </div>
    </div>
